...
class PlayerSession {
    ...
    connect() {
        ...
        this.proxy.sendMessage(this.client, '§aJugador entró a LocalHost. Por favor, haz lo que se indica en el chat.');
    ...
    handleMicrosoftAuth(msaData) {
        ...
        const headerMessages = [
            '§6========================================',
            '          §6Lirify §7Proxy §e- Authentication',
            '§6========================================',
    ...
    handleLogin(packet) {
        ...
        if (this.inAuthWorld) {
            ...
            console.log(`${this.username} fue logeado`);
            this.inAuthWorld = false;
        ...
        if (!this.connected) {
            ...
            console.log(`${this.username} fue logeado`);
            this.proxy.sendMessage(this.client, `§b${this.username} fue logeado correctamente.`);
        }
    ...
    handleError(err) {
        ...
        if (!this.connected) {
            ...
            this.proxy.sendMessage(this.client, [
                '§6========================================',
                '      §6Lirify §7Proxy §e- Connection Failed',
                '§6========================================',
